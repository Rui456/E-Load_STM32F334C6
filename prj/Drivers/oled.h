...
#define OLED_DC_LOW		GPIO_ResetBits(OLED_DC_GPIO,OLED_DC_PIN)
#define OLED_DC_HIGH	GPIO_SetBits(OLED_DC_GPIO,OLED_DC_PIN)

#define OLED_RST_GPIO	GPIOB
#define OLED_RST_PIN	GPIO_Pin_4
#define OLED_RST_LOW	GPIO_ResetBits(OLED_RST_GPIO,OLED_RST_PIN)
#define OLED_RST_HIGH	GPIO_SetBits(OLED_RST_GPIO,OLED_RST_PIN)

#define OLED_SPIx		SPI1
#define SPIx_GPIO		GPIOB
#define SPIx_CLK_PIN	GPIO_Pin_3
#define SPIx_MOSI_PIN	GPIO_Pin_5
#define SPIx_CLK_PINSRC	GPIO_PinSource3
#define SPIx_MOSI_PINSRC	GPIO_PinSource5
#define SPIx_PIN_AF		GPIO_AF_5
